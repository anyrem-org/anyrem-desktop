...
contextBridge.exposeInMainWorld('desktop', {
  ...
  getRefreshToken: (): Promise<string | null> => ipcRenderer.invoke('auth:refresh-token:get'),
  setRefreshToken: (token: string): Promise<void> => ipcRenderer.invoke('auth:refresh-token:set', token),
  clearRefreshToken: (): Promise<void> => ipcRenderer.invoke('auth:refresh-token:clear'),
